...
type Store struct {
	...
	queries   map[application.ListFilter]cachedList
}

type cachedList struct {
	items []*domain.RetirementCase
	total int
}
...
func Open(directory string) (*Store, error) {
	...
	store := &Store{directory: directory, locks: map[string]*sync.Mutex{}, queries: map[application.ListFilter]cachedList{}}
